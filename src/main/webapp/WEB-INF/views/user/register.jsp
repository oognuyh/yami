            ...
            <div class="row g-3" style="max-width: 400px">
              ...
              <div class="col-12">
                ...
                <input
                  ...
                  type="text"
                  name="nickname"
                  :class="['form-control', error.nickname && 'is-invalid']"
                  id="nickname"
                />
              ...
              <div class="col-12">
                ...
                <input
                  ...
                  type="text"
                  name="tel"
                  :class="['form-control', error.tel && 'is-invalid']"
                  id="tel"
                />
              ...
              <div class="col-12">
                ...
                <input
                  ...
                  type="text"
                  name="address1"
                  :class="['form-control', error.address1 && 'is-invalid']"
                  id="address1"
                />
              ...
              <div class="col-12">
                ...
                <input
                  ...
                  type="text"
                  name="address2"
                  :class="['form-control', error.address2 && 'is-invalid']"
                  id="address2"
                />
              ...
              <div class="col-12 d-grid gap-3">
                ...
                >
                  <span class="text-dark">이미 회원이신가요?</span>
                  로그인
                </a>
              </div>
            </div>
